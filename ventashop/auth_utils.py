"""An authorisation utilities module for ventashop app."""

from ventashop.models import User
...
class TestIsCustomerOrEmployeeMixin(UserPassesTestMixin):
    ...
    def test_func(self):
        return (self.request.user.role == "CUSTOMER" or self.request.user.role == "EMPLOYEE")
